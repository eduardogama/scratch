...
class Simulation():
    ...
    def __init__(self, nusers) -> None:
        self.net = Mininet_wifi(controller=Controller, link=wmediumd, ac_method='ssf',
                                accessPoint=UserAP, wmediumd_mode=interference)
    ...
    def createAccessPoints(self) -> object:
        ...
        ap1 = self.net.addAccessPoint('ap1', mac='00:00:00:11:00:01', encrypt='wpa2',
                                ssid='ssid-1', channel='1', position='15,30,0', **kwargs)
        ap2 = self.net.addAccessPoint('ap2', mac='00:00:00:11:00:02', encrypt='wpa2',
                                ssid='ssid-2', channel='6', position='35,30,0', **kwargs)
        ap3 = self.net.addAccessPoint('ap3', mac='00:00:00:11:00:03', encrypt='wpa2',
                                ssid='ssid-3', channel='11', position='55,30,0', **kwargs)
    ...
    def createStations(self, nusers) -> object:
        sta1 = self.net.addStation('sta1', mac='00:00:00:00:00:10', bgscan_threshold=-60,
                                   s_inverval=1, l_interval=2, bgscan_module="simple", position='30,30,0')
        sta2 = self.net.addStation('sta2', mac='00:00:00:00:00:20', bgscan_threshold=-60,
                                   s_inverval=1, l_interval=2, bgscan_module="simple", position='30,40,0')

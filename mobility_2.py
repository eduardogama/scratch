...
def topology(args):
    ...
    sta1 = net.addStation('sta1', mac='00:00:00:00:00:01', min_x=100, max_x=2000, min_y=100, max_y=1400, min_v=10, max_v=20)
    sta2 = net.addStation('sta2', mac='00:00:00:00:00:02', min_x=100, max_x=2000, min_y=100, max_y=1400, min_v=3, max_v=5)
    ...
    net.setMobilityModel(time=0, model='RandomDirection', max_x=2000, max_y=1200, seed=20)
